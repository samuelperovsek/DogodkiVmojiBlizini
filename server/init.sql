...
(5, 'Koncert pod zvezdami', 'Nepozaben večer slovenske popevke.', 'Nepozaben večer slovenske popevke na prostem s krasnim ambientom.', 1000, 'Prešernov trg 1', 'Prešernov trg', '2026-06-15 20:00:00', '2026-06-15 23:00:00', 0, '040 741 242', 'tajnistvo@kdradlje.si', NULL, 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800&q=80', 1500, 1262, 'Plačljivo', 22.00, 'aktiven', 1, 46.0569, 14.5058),
...
INSERT INTO Dogodek (TK_uporabnik_organizator, Naslov, kratek_opis, opis, TK_kraj, ulica, ime_prizorisca, datum_zacetka, datum_konca, vecdnevno, telefon, email, spletna_stran, slika, st_sedezov, st_prostih_sedezov, tip_cene, cena, status, TK_kategorija, lat, lng) VALUES
(5, 'Jazz pod zvezdami', 'Večer vrhunskega jazza v starem mestnem jedru.', 'Tradicionalni poletni večer, kjer bodo nastopili domači in tuji jazz virtuozi.', 1000, 'Gornji trg 4', 'Stari trg', '2026-06-20 21:00:00', '2026-06-21 00:30:00', 0, '041 111 222', 'jazz@ljubljana.si', NULL, 'https://images.unsplash.com/photo-1514525253161-7a46d19cd819?w=800&q=80', 200, 45, 'Plačljivo', 12.00, 'aktiven', 1, 46.0498, 14.5068),
(5, 'Metal Open Air', 'Glasni kitarski rifi na prostem.', 'Enodnevni mini festival za vse ljubitelje trših ritmov in dobre družbe.', 2000, 'Koroška cesta 12', 'Mestni park Maribor', '2026-06-28 17:00:00', '2026-06-28 23:55:00', 0, '02 222 33 44', 'metal@maribor.si', NULL, 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800&q=80', 800, 540, 'Plačljivo', 25.00, 'aktiven', 1, 46.5624, 15.6455),
...
(5, 'Uvod v UI in ChatGPT', 'Kratka delavnica o uporabi umetne inteligence.', 'Naučite se, kako učinkovito pisati ukaze (prompte) in si olajšati vsakdanje delo.', 1000, 'Dunajska cesta 56', 'Tehnološki park', '2026-08-12 18:00:00', '2026-08-12 20:30:00', 0, '01 444 55 66', 'ai@tech.si', NULL, 'https://images.unsplash.com/photo-1531482615713-2afd69097998?w=800&q=80', 60, 4, 'Plačljivo', 35.00, 'aktiven', 3, 46.0722, 14.5102),
...
(5, 'Fotografija za začetnike', 'Spoznajte nastavitve svojega DSLR fotoaparata.', 'Praktična delavnica na terenu, kjer se bomo naučili osnov kompozicije in svetlobe.', 4000, 'Maistrova ulica 5', 'Kulturni dom Kranj', '2026-09-05 09:00:00', '2026-09-05 14:00:00', 0, '040 888 777', 'foto@kranj.si', NULL, 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=800&q=80', 25, 14, 'Plačljivo', 40.00, 'aktiven', 3, 46.2415, 14.3599),
...
(5, 'Stand Up Večer smeha', 'Nastop štirih znanih domačih komikov.', 'Pridite na porcijo smeha v dvorano kulturnega doma. Smeh do solz zagotovljen!', 4000, 'Koroška ulica 10', 'Kulturni center Kranj', '2026-09-18 20:00:00', '2026-09-18 22:00:00', 0, '04 201 11 22', 'smeh@kranj.si', NULL, 'https://images.unsplash.com/photo-1585699324551-f6c309eed262?w=800&q=80', 250, 89, 'Plačljivo', 15.00, 'aktiven', 4, 46.2420, 14.3542),
(5, 'Komedija: Popolna zmeda', 'Gledališka uspešnica v izvedbi lokalnega društva.', 'Zabavna dvoranska predstava o dveh sosedih, ki si nenehno nagajata.', 4000, 'Glavni trg 12', 'Mestno gledališče Kranj', '2026-10-02 19:30:00', '2026-10-02 21:30:00', 0, '04 201 33 00', 'gledalisce@kranj.si', NULL, 'https://images.unsplash.com/photo-1507676184212-d03ab07a01bf?w=800&q=80', 400, 310, 'Plačljivo', 12.00, 'aktiven', 4, 46.2395, 14.3562),

(5, 'Veliki koncert: Siddharta', 'Ekskluzivni stadionski spektakel ob obletnici.', 'Skupina Siddharta se vrača na domači oder z vsemi največjimi uspešnicami.', 1000, 'Vojkova cesta 100', 'Stadion Stožice', '2026-06-18 21:00:00', '2026-06-18 23:55:00', 0, '01 200 00 00', 'karte@siddharta.si', 'https://www.siddharta.si', 'https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800&q=80', 10000, 4320, 'Plačljivo', 35.00, 'promoviran', 1, 46.0804, 14.5245),
